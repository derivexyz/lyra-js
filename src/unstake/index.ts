...
export class Unstake {
  ...
  static async get(lyra: Lyra, owner: string, amount: BigNumber): Promise<Unstake> {
  ...
  static async unstake(lyra: Lyra, owner: string): Promise<PopulatedTransaction | null> {
    const tx = null // TODO: @dillonlin create from contracts
    return tx
  }
}
