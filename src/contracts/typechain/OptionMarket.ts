...
export interface OptionMarketInterface extends utils.Interface {
  ...
  functions: {
    ...
    'optionBoards(uint256)': FunctionFragment
  ...
  encodeFunctionData(functionFragment: 'optionBoards', values: [BigNumberish]): string
  ...
  encodeFunctionData(functionFragment: 'strikes', values: [BigNumberish]): string
  ...
  decodeFunctionResult(functionFragment: 'optionBoards', data: BytesLike): Result
  ...
  events: {
    ...
    'Trade(address,uint256,uint256,tuple,tuple[],tuple)': EventFragment
  }
...
export type BoardBaseIvSetEvent = TypedEvent<[BigNumber, BigNumber], { boardId: BigNumber; baseIv: BigNumber }>
...
export type BoardFrozenEvent = TypedEvent<[BigNumber, boolean], { boardId: BigNumber; frozen: boolean }>
...
export type StrikeSkewSetEvent = TypedEvent<[BigNumber, BigNumber], { strikeId: BigNumber; skew: BigNumber }>
...
export interface OptionMarket extends BaseContract {
  ...
  filters: {
    ...
    'Trade(address,uint256,uint256,tuple,tuple[],tuple)'(
      trader?: string | null,
      strikeId?: BigNumberish | null,
  ...
  estimateGas: {
    ...
    optionBoards(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    optionBoards(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>
    ...
    strikes(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>
  }
}
