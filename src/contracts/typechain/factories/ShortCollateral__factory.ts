...
import type { ShortCollateral, ShortCollateralInterface } from '../ShortCollateral'
...
export class ShortCollateral__factory {
  ...
  static connect(address: string, signerOrProvider: Signer | Provider): ShortCollateral {
