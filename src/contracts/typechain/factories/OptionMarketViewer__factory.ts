...
import type { OptionMarketViewer, OptionMarketViewerInterface } from '../OptionMarketViewer'
    ...
    outputs: [
      {
        ...
        internalType: 'struct OptionMarketViewer.LiquidityBalanceAndAllowance[]',
        name: '',
        type: 'tuple[]',
      },
    ],
...
export class OptionMarketViewer__factory {
  static readonly abi = _abi
  static createInterface(): OptionMarketViewerInterface {
    return new utils.Interface(_abi) as OptionMarketViewerInterface
  }
  static connect(address: string, signerOrProvider: Signer | Provider): OptionMarketViewer {
