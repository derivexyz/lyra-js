...
export interface TestFaucetInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'addresses', values: [BigNumberish]): string
  encodeFunctionData(functionFragment: 'drip', values?: undefined): string
  encodeFunctionData(functionFragment: 'permitModify', values: [string, boolean]): string
  ...
  encodeFunctionData(functionFragment: 'setDripAmount', values: [string, BigNumberish]): string
  ...
  decodeFunctionResult(functionFragment: 'permitModify', data: BytesLike): Result
...
export type DrippedEvent = TypedEvent<[string, BigNumber], { token: string; amount: BigNumber }>
...
export interface TestFaucet extends BaseContract {
  ...
  callStatic: {
    ...
    permitModify(user: string, permit: boolean, overrides?: CallOverrides): Promise<void>

    permitted(arg0: string, overrides?: CallOverrides): Promise<boolean>

    received(arg0: string, overrides?: CallOverrides): Promise<boolean>

    setDripAmount(token: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>
  }
  ...
  estimateGas: {
    addresses(arg0: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>
  ...
  populateTransaction: {
    addresses(arg0: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>
    ...
    permitted(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>

    received(arg0: string, overrides?: CallOverrides): Promise<PopulatedTransaction>
