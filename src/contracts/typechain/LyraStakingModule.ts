...
export interface LyraStakingModuleInterface extends utils.Interface {
  contractName: "LyraStakingModule";
  functions: {
...
export type DelegatedPowerChangedEventFilter =
  TypedEventFilter<DelegatedPowerChangedEvent>;
...
export interface LyraStakingModule extends BaseContract {
  contractName: "LyraStakingModule";
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: LyraStakingModuleInterface;
