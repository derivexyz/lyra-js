...
export declare namespace OptionMarketViewer {
  ...
  export type LiquidityBalanceAndAllowanceStructOutput = [string, BigNumber, BigNumber] & {
    token: string
    balance: BigNumber
    allowance: BigNumber
  }
  ...
  export type MarketOptionPositionsStructOutput = [string, OptionToken.OptionPositionStructOutput[]] & {
    market: string
...
export declare namespace PoolHedger {
  ...
  export type PoolHedgerParametersStructOutput = [BigNumber, BigNumber, BigNumber] & {
...
export interface OptionMarketViewerInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'getBoard', values: [string, BigNumberish]): string
  encodeFunctionData(functionFragment: 'getBoardForBaseKey', values: [BytesLike, BigNumberish]): string
  encodeFunctionData(functionFragment: 'getBoardForStrikeId', values: [string, BigNumberish]): string
  encodeFunctionData(functionFragment: 'getLiquidityBalancesAndAllowances', values: [string[], string]): string
  encodeFunctionData(functionFragment: 'getLiveBoards', values: [string]): string
  ...
  encodeFunctionData(functionFragment: 'getMarketForBaseKey', values: [BytesLike]): string
  encodeFunctionData(functionFragment: 'getMarkets', values: [string[]]): string
...
export interface OptionMarketViewer extends BaseContract {
  ...
  functions: {
    ...
    getMarket(market: string, overrides?: CallOverrides): Promise<[OptionMarketViewer.MarketViewWithBoardsStructOutput]>
    ...
    getMarkets(markets: string[], overrides?: CallOverrides): Promise<[OptionMarketViewer.MarketViewStructOutput[]]>
  ...
  getLiveBoards(market: string, overrides?: CallOverrides): Promise<OptionMarketViewer.BoardViewStructOutput[]>
  ...
  estimateGas: {
    ...
    getBoard(market: string, boardId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>

    getBoardForBaseKey(baseKey: BytesLike, boardId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>

    getBoardForStrikeId(market: string, strikeId: BigNumberish, overrides?: CallOverrides): Promise<BigNumber>

    getLiquidityBalancesAndAllowances(markets: string[], owner: string, overrides?: CallOverrides): Promise<BigNumber>

    getLiveBoards(market: string, overrides?: CallOverrides): Promise<BigNumber>
    ...
    getMarketForBaseKey(baseKey: BytesLike, overrides?: CallOverrides): Promise<BigNumber>

    getMarkets(markets: string[], overrides?: CallOverrides): Promise<BigNumber>
    ...
    init(_synthetixAdapter: string, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>
  ...
  populateTransaction: {
    ...
    getBoard(market: string, boardId: BigNumberish, overrides?: CallOverrides): Promise<PopulatedTransaction>
    ...
    getLiveBoards(market: string, overrides?: CallOverrides): Promise<PopulatedTransaction>

    getMarket(market: string, overrides?: CallOverrides): Promise<PopulatedTransaction>

    getMarketAddresses(overrides?: CallOverrides): Promise<PopulatedTransaction>

    getMarketForBaseKey(baseKey: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>

    getMarkets(markets: string[], overrides?: CallOverrides): Promise<PopulatedTransaction>
