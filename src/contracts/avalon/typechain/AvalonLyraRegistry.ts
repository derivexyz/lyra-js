...
export interface AvalonLyraRegistryInterface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(
    ...
    values: [LyraRegistry.OptionMarketAddressesStruct]
  ): string;
  encodeFunctionData(
...
export interface AvalonLyraRegistry extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AvalonLyraRegistryInterface;
