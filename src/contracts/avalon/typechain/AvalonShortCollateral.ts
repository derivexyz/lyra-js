...
export interface AvalonShortCollateralInterface extends utils.Interface {
  functions: {
...
export interface AvalonShortCollateral extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AvalonShortCollateralInterface;
