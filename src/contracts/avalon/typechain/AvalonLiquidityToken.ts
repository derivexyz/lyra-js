...
export interface AvalonLiquidityTokenInterface extends utils.Interface {
  functions: {
...
export interface AvalonLiquidityToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: AvalonLiquidityTokenInterface;
