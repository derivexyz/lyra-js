...
import type {
  AvalonOptionToken,
  AvalonOptionTokenInterface,
} from "../AvalonOptionToken";
...
export class AvalonOptionToken__factory {
  static readonly abi = _abi;
  static createInterface(): AvalonOptionTokenInterface {
    return new utils.Interface(_abi) as AvalonOptionTokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AvalonOptionToken {
    return new Contract(address, _abi, signerOrProvider) as AvalonOptionToken;
  }
}
