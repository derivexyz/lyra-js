...
import type {
  ...
  AvalonLiquidityTokenInterface,
} from "../AvalonLiquidityToken";
...
export class AvalonLiquidityToken__factory {
  ...
  static createInterface(): AvalonLiquidityTokenInterface {
    return new utils.Interface(_abi) as AvalonLiquidityTokenInterface;
  }
  static connect(
    address: string,
