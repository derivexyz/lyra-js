...
import type {
  AvalonLyraRegistry,
  AvalonLyraRegistryInterface,
} from "../AvalonLyraRegistry";
...
export class AvalonLyraRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): AvalonLyraRegistryInterface {
    return new utils.Interface(_abi) as AvalonLyraRegistryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AvalonLyraRegistry {
    return new Contract(address, _abi, signerOrProvider) as AvalonLyraRegistry;
  }
}
