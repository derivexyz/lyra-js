...
import type {
  AvalonLiquidityPool,
  AvalonLiquidityPoolInterface,
} from "../AvalonLiquidityPool";
...
export class AvalonLiquidityPool__factory {
  static readonly abi = _abi;
  static createInterface(): AvalonLiquidityPoolInterface {
    return new utils.Interface(_abi) as AvalonLiquidityPoolInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AvalonLiquidityPool {
    return new Contract(address, _abi, signerOrProvider) as AvalonLiquidityPool;
  }
}
