...
import type {
  AvalonOptionMarket,
  AvalonOptionMarketInterface,
} from "../AvalonOptionMarket";
...
export class AvalonOptionMarket__factory {
  static readonly abi = _abi;
  static createInterface(): AvalonOptionMarketInterface {
    return new utils.Interface(_abi) as AvalonOptionMarketInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): AvalonOptionMarket {
    return new Contract(address, _abi, signerOrProvider) as AvalonOptionMarket;
  }
}
