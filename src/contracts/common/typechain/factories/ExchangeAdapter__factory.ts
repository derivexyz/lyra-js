...
export class ExchangeAdapter__factory {
  static readonly abi = _abi;
  static createInterface(): ExchangeAdapterInterface {
    return new utils.Interface(_abi) as ExchangeAdapterInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ExchangeAdapter {
    return new Contract(address, _abi, signerOrProvider) as ExchangeAdapter;
  }
}
