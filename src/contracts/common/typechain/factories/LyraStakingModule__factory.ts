...
import type {
  LyraStakingModule,
  LyraStakingModuleInterface,
} from "../LyraStakingModule";
...
export class LyraStakingModule__factory {
  ...
  static createInterface(): LyraStakingModuleInterface {
    return new utils.Interface(_abi) as LyraStakingModuleInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): LyraStakingModule {
    return new Contract(address, _abi, signerOrProvider) as LyraStakingModule;
  }
}
