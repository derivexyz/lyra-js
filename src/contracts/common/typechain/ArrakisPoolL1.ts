...
export interface ArrakisPoolL1Interface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "RESTRICTED_MINT_ENABLED",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "arrakisBalance0",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "arrakisBalance1",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "arrakisFeeBPS",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "arrakisTreasury",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "restrictedMintToggle",
    values?: undefined
  ): string;
  encodeFunctionData(functionFragment: "symbol", values?: undefined): string;
  encodeFunctionData(
    functionFragment: "toggleRestrictMint",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "withdrawArrakisBalance",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export type UpdateManagerParamsEventFilter =
  TypedEventFilter<UpdateManagerParamsEvent>;
