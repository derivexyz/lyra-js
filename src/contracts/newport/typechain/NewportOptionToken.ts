...
export interface NewportOptionTokenInterface extends utils.Interface {
  functions: {
...
export interface NewportOptionToken extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NewportOptionTokenInterface;
