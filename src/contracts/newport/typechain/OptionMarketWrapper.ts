...
export interface OptionMarketWrapperInterface extends utils.Interface {
  ...
  events: {
    ...
    "WETHDeposit(address,uint256)": EventFragment;
    "WrapperParamsUpdated(address,address,uint256)": EventFragment;
  };
  ...
  getEvent(nameOrSignatureOrTopic: "WETHDeposit"): EventFragment;
...
export interface WETHDepositEventObject {
  sender: string;
  amount: BigNumber;
}
export type WETHDepositEvent = TypedEvent<
  [string, BigNumber],
  WETHDepositEventObject
>;

export type WETHDepositEventFilter = TypedEventFilter<WETHDepositEvent>;
...
export interface OptionMarketWrapper extends BaseContract {
  ...
  filters: {
    ...
    "WETHDeposit(address,uint256)"(
      sender?: null,
      amount?: null
    ): WETHDepositEventFilter;
    WETHDeposit(sender?: null, amount?: null): WETHDepositEventFilter;

    "WrapperParamsUpdated(address,address,uint256)"(
      curveSwap?: null,
      tradingRewards?: null,
