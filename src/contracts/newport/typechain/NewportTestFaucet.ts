...
export interface NewportTestFaucetInterface extends utils.Interface {
  functions: {
...
export interface NewportTestFaucet extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: NewportTestFaucetInterface;
