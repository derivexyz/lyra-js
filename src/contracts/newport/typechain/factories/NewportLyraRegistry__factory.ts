...
import type {
  NewportLyraRegistry,
  NewportLyraRegistryInterface,
} from "../NewportLyraRegistry";
...
export class NewportLyraRegistry__factory {
  static readonly abi = _abi;
  static createInterface(): NewportLyraRegistryInterface {
    return new utils.Interface(_abi) as NewportLyraRegistryInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): NewportLyraRegistry {
    return new Contract(address, _abi, signerOrProvider) as NewportLyraRegistry;
  }
}
