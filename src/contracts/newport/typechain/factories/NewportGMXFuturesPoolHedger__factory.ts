...
import type {
  ...
  NewportGMXFuturesPoolHedgerInterface,
} from "../NewportGMXFuturesPoolHedger";
...
const _abi = [
        ...
        components: [
          ...
          },
          {
            components: [
              ...
              {
                internalType: "uint256",
                name: "remainingLongDollars",
                type: "uint256",
              },
              {
                internalType: "uint256",
                name: "remainingShortDollars",
                type: "uint256",
              },
            ],
  ...
  },
  {
    ...
    name: "getRemainingLongLiquidityDollars",
    outputs: [
      {
        internalType: "uint256",
        name: "remainingDollars",
        type: "uint256",
      },
    ],
    stateMutability: "view",
  ...
  {
    inputs: [],
    name: "getRemainingShortLiquidityDollars",
    outputs: [
      {
        internalType: "uint256",
        name: "remainingDollars",
...
export class NewportGMXFuturesPoolHedger__factory {
  static readonly abi = _abi;
  static createInterface(): NewportGMXFuturesPoolHedgerInterface {
    return new utils.Interface(_abi) as NewportGMXFuturesPoolHedgerInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as NewportGMXFuturesPoolHedger;
  }
}
