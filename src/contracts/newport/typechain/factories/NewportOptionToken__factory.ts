...
import type {
  NewportOptionToken,
  NewportOptionTokenInterface,
} from "../NewportOptionToken";
...
export class NewportOptionToken__factory {
  static readonly abi = _abi;
  static createInterface(): NewportOptionTokenInterface {
    return new utils.Interface(_abi) as NewportOptionTokenInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): NewportOptionToken {
    return new Contract(address, _abi, signerOrProvider) as NewportOptionToken;
  }
}
