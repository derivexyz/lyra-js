...
} from "../NewportSNXPerpsV2PoolHedger";
...
export class NewportSNXPerpsV2PoolHedger__factory {
  static readonly abi = _abi;
  static createInterface(): NewportSNXPerpsV2PoolHedgerInterface {
    return new utils.Interface(_abi) as NewportSNXPerpsV2PoolHedgerInterface;
  }
  static connect(
    address: string,
    ...
    return new Contract(
      ...
      _abi,
      signerOrProvider
    ) as NewportSNXPerpsV2PoolHedger;
  }
}
