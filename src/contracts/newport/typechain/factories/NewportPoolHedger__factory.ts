...
import type {
  NewportPoolHedger,
  NewportPoolHedgerInterface,
} from "../NewportPoolHedger";
...
export class NewportPoolHedger__factory {
  static readonly abi = _abi;
  static createInterface(): NewportPoolHedgerInterface {
    return new utils.Interface(_abi) as NewportPoolHedgerInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): NewportPoolHedger {
    return new Contract(address, _abi, signerOrProvider) as NewportPoolHedger;
  }
}
