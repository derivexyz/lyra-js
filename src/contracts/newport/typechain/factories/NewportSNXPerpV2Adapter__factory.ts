...
import type {
  ...
  NewportSNXPerpV2AdapterInterface,
...
const _abi = [
  ...
  {
    inputs: [],
    name: "InvalidSNXPerpV2Price",
    type: "error",
  },
  {
    inputs: [],
    name: "InvalidStaticEstimationDiscount",
    type: "error",
  },
  {
    inputs: [
  ...
  },
  {
    ...
    inputs: [
      ...
      },
      {
        indexed: false,
        internalType: "uint256",
        name: "staticEstimationDiscount",
        type: "uint256",
      },
      {
        indexed: false,
        internalType: "address",
        name: "snxPerpV2Market",
        type: "address",
      },
      {
        indexed: false,
    ...
    name: "MarketAdapterConfigurationUpdated",
    type: "event",
  },
  {
    anonymous: false,
    ...
    inputs: [
      {
        indexed: false,
        internalType: "address",
        name: "synthetixSystemStatus",
        type: "address",
      },
    ],
    name: "SynthetixSystemStatusUpdated",
    type: "event",
  },
  {
    anonymous: false,
    ...
    outputs: [
      {
        components: [
          {
            components: [
              ...
              },
              {
                ...
                internalType: "struct SNXPerpV2Adapter.UniswapPoolInfo",
                name: "uniswapInfo",
                type: "tuple",
              },
            ],
            internalType: "struct SNXPerpV2Adapter.MarketAdapterConfiguration",
            name: "config",
            type: "tuple",
          },
          {
        ...
        internalType: "struct SNXPerpV2Adapter.MarketAdapterState",
        name: "",
        type: "tuple",
      },
    ],
  ...
  },
  {
    inputs: [
      ...
      {
        internalType: "uint256",
        name: "_staticEstimationDiscount",
        type: "uint256",
      },
      {
        internalType: "address",
        name: "_snxPerpV2MarketAddress",
        type: "address",
      },
      {
        internalType: "address",
    ...
    name: "setMarketAdapterConfiguration",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  },
...
export class NewportSNXPerpV2Adapter__factory {
  static readonly abi = _abi;
  static createInterface(): NewportSNXPerpV2AdapterInterface {
    return new utils.Interface(_abi) as NewportSNXPerpV2AdapterInterface;
  }
  static connect(
    address: string,
