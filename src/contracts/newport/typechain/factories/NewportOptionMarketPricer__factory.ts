...
import type {
  ...
  NewportOptionMarketPricerInterface,
} from "../NewportOptionMarketPricer";
...
export class NewportOptionMarketPricer__factory {
  static readonly abi = _abi;
  static createInterface(): NewportOptionMarketPricerInterface {
    return new utils.Interface(_abi) as NewportOptionMarketPricerInterface;
  }
  static connect(
    address: string,
