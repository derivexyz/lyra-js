...
import type {
  NewportOptionMarket,
  NewportOptionMarketInterface,
} from "../NewportOptionMarket";
...
export class NewportOptionMarket__factory {
  static readonly abi = _abi;
  static createInterface(): NewportOptionMarketInterface {
    return new utils.Interface(_abi) as NewportOptionMarketInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): NewportOptionMarket {
    return new Contract(address, _abi, signerOrProvider) as NewportOptionMarket;
  }
}
